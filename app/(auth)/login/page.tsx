...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center px-6 py-12 max-w-md mx-auto w-full min-h-screen">
      ...
      <button
        disabled
        className="btn-press w-full py-3.5 bg-white border border-border-light rounded-2xl font-semibold text-sm text-slate-400 flex items-center justify-center gap-3 transition-colors animate-fade-in-up delay-200 cursor-not-allowed"
      >
